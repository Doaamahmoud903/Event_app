...
class AppStyles {
  static TextStyle bold12white = TextStyle(
      fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.whiteColor);
  static TextStyle bold12Black = TextStyle(
      fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.blackColor);

  static TextStyle semibold14lightGray = TextStyle(
      fontSize: 14,
      fontWeight: FontWeight.w700,
      color: AppColors.lightGrayColor);

  static TextStyle semibold14lightblue = TextStyle(
  ...
  static TextStyle bold14Blue = TextStyle(
      fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.blueColor);
  static TextStyle bold14White = TextStyle(
      fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.whiteColor);
  static TextStyle bold14Gray = TextStyle(
      fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.grey2);
  ...
  static TextStyle semiBold18Black = TextStyle(
  ...
  static TextStyle bold16Blue = TextStyle(
      fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.blueColor);

  static TextStyle semibold16lightGray = TextStyle(
      fontSize: 16,
  ...
  static TextStyle bold20Blue = TextStyle(
      fontSize: 20, fontWeight: FontWeight.w700, color: AppColors.blueColor);
  ...
  static TextStyle bold22white = TextStyle(
      fontSize: 22, fontWeight: FontWeight.w700, color: AppColors.whiteColor);
  static TextStyle bold24Blue = TextStyle(
      fontSize: 24, fontWeight: FontWeight.w700, color: AppColors.blueColor);
  static TextStyle bold24lightGray = TextStyle(
      fontSize: 24,
      fontWeight: FontWeight.w700,
      color: AppColors.lightGrayColor);
}
